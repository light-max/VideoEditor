...
public class DefaultTextureInputSourceRenderer implements GLTextureInputSourceHolder.Renderer {
    private static final String VERTEX_SHADER = "#version 300 es\n" +
            ...
            "out vec2 texCoord;\n" +
            "void main() {\n" +
            "    gl_Position = vMatrix * vec4(vertex[2], vertex[3], 0., 1.);\n" +
    ...
    @Override
    public void onDrawFrame(float[] vertexTransformMatrix, int texName, float[] textureTransformMatrix) {
        ...
        GLES30.glUniformMatrix4fv(1, 1, false, vertexTransformMatrix, 0);
